...
function pleiadesweb16_setup() {
	 ...
	 * If you're building a theme based on Pleiades Web 2016, use a find and replace
	 * to change 'pleiadesweb16' to the name of your theme in all the template files.
	 */
